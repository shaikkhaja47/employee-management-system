...
public class Employee {
	...
	public Employee( String name, String email, double salary, String designation, String department) {
		super();
		this.name = name;
		this.email = email;
		this.salary = salary;
	...
	@Override
	public int hashCode() {
		return Objects.hash(department, designation, email, id, name, salary);
	}
	@Override
